$(function() {
      ...
      var i = function() {
        var i = window.innerWidth > 0 ? window.innerWidth : this.screen.width,
          e = 70;
        4170 > i ? ($("body").addClass("minid-sidebar"), $(".navbar-brand span").hide(),
      ...
      }), $("#monthchart").sparkline([5,6,2,9,4,7,10,12],{type:"bar",height:"35",barWidth:"4",resize:!0,barSpacing:"4",barColor:"#1e88e5"}),$("#lastmonthchart").sparkline([5,6,2,9,4,7,10,12],{type:"bar",height:"35",barWidth:"4",resize:!0,barSpacing:"4",barColor:"#7460ee"})});
