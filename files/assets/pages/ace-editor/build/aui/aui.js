...
(function() {
    ...
    var proto, prop,
        VERSION = '3.4.0',
        PERIOD = '.',
        BASE = '../../../../../../../../yui.yahooapis.com/index.html',
 ...
 *              base: '../../../../../../../../yui.yahooapis.com/2.8.0r4/build/index.html',
 * 
...
Y.Get = {
     ...
     * <pre>
     * &nbsp; Y.Get.script(
     * &nbsp; ["../../../../../../../../yui.yahooapis.com/2.5.2/build/yahoo/yahoo-min.js",
     * &nbsp;  "../../../../../../../../yui.yahooapis.com/2.5.2/build/event/event-min.js"],
     * &nbsp; &#123;
...
add('load', '0', {
	...
	return (DOCUMENT && !DOCUMENT.implementation.hasFeature("../../../../../../../../www.w3.org/TR/SVG11/feature.html", "1.1") && (canvas && canvas.getContext && canvas.getContext("2d")));
}, 
    "trigger": "graphics"
});
...
add('load', '2', {
    ...
    "test": function(Y) {
    var DOCUMENT = Y.config.doc;
	return (DOCUMENT && DOCUMENT.implementation.hasFeature("../../../../../../../../www.w3.org/TR/SVG11/feature.html", "1.1"));
}, 
    "trigger": "graphics"
});
// history-hash-ie
		...
		AUI._uaExtensions = function(A) {
			...
			*/
			...
			if (!documentElement._yuid) {
				...
				vml = !(svg = !!(CONFIG.win.SVGAngle || DOC.implementation.hasFeature('../../../../../../../../www.w3.org/TR/SVG11/feature.html', '1.1')));
